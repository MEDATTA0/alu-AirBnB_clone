...
class TestBaseModel(unittest.TestCase):
    ...
    def test_create_instance(self):
        ...
        self.assertLessEqual(
            time_diff,
            1,
            "updated_at and created_at should be nearly equal on creation"
        )
    ...
    def test_save_instance(self):
        ...
        self.assertGreater(
            ...
            1,
            "save() should update updated_at to a later time"
        )

    def test_to_dict(self):
        """Test to_dict() returns a valid dictionary representation."""
        instance = BaseModel()
